...
public class ZDT5 extends Problem {
  ...
  */
  ...
  public ZDT5(String solutionType, int objectivesNumber) throws ClassNotFoundException {
    this(solutionType, 11, objectivesNumber); // 30 variables by default    
  } // ZDT1
  
  public ZDT5(String solutionType, Integer numberOfVariables, int objectivesNumber) throws ClassNotFoundException {
  ...
  * This problem allows only "Binary" representations.
  */
  public ZDT5(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
    numberOfVariables_  = numberOfVariables.intValue();
    numberOfObjectives_ = 2;
    numberOfConstraints_= 0;
    problemName_        = "ZDT5";    
