...
public class ZDT6 extends Problem {
  ...
  */
  ...
  public ZDT6(String solutionType, int objectivesNumber) throws ClassNotFoundException {
    this(solutionType, 10, objectivesNumber); // 30 variables by default    
  } // ZDT1
  
  public ZDT6(String solutionType, Integer numberOfVariables, int objectivesNumber) throws ClassNotFoundException {
