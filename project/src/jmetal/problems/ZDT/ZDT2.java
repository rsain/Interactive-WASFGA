...
public class ZDT2 extends Problem{
  ...
  */
  ...
  public ZDT2(String solutionType, int objectivesNumber) throws ClassNotFoundException {
    this(solutionType, 30, objectivesNumber); // 30 variables by default    
  } // ZDT1
  
  public ZDT2(String solutionType, Integer numberOfVariables, int objectivesNumber) throws ClassNotFoundException {
