...
public class MOEAD extends Algorithm {
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    weightsDirectory_ = this.getInputParameter("weightsDirectory").toString();
        weightFileName = weightsDirectory_ + "/W" + problem_.getNumberOfObjectives() + "D-"
                    + populationSize_ + ".dat";
...
*/
    ...
    if (problem_.getNumberOfObjectives() == 2)
        lambda_ = Weights.initUniformWeights2D(0.005, populationSize_);
    else
        lambda_ = Weights.getWeightsFromFile(weightFileName);
